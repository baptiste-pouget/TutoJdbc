...
public class TestJDBC {
	// Chaine de connexion
	static final String CONNECT_URL = "jdbc:mysql://mysql-baptiste-pouget.alwaysdata.net:3306/baptiste-pouget_db";
	static final String LOGIN = "144386";
	static final String PASSWORD = "mdp";
	// La requete de test
